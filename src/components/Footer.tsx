...
const Footer = () => {
  ...
  <div className="relative block h-32 lg:col-span-2 lg:h-full">
    <Image
      ...
      style={{
        filter: 'drop-shadow(3px 3px #D69738) sepia(100%) drop-shadow(-3px -3px #D69738)'
      }}
    />
  </div>
  ...
  <div className="px-4 py-16 sm:px-6 lg:col-span-3 lg:px-8">
        ...
        <ul className="mt-8 flex gap-6">
          <li>
            ...
            >
              ...
              <svg className="size-6 hover:fill-primary" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
    ...
    <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
        <p className='mb-2 text-xs text-lightText dark:text-darkText'>MangaNest does not store any files on our server, we only linked to the media which is hosted on 3rd party services.</p>
      <div className="sm:flex sm:items-center sm:justify-between">
        <ul className="flex flex-wrap gap-4 text-xs">
          <li>
            <a href="#" className="text-gray-500 transition hover:opacity-75 hover:text-primary hover:dark:text-primary dark:text-gray-400">
              Terms & Conditions
            </a>
          </li>
        ...
        <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
          &copy; 2024. Manga Nest. All rights reserved.
        </p>
      </div>
    </div>
  </div>
